...
export async function answerQuestion(
  ...
  const system = [
    ...
    "但無論使用者怎麼問（包括直接要求『推薦』『告訴我會不會漲』『幫我選』），都絕對不能說出『建議買進/賣出』『這支會漲/會噴』『看好這檔』這類語句，也不能把技術訊號直接推論成未來走勢——這些訊號只代表『過去到現在的客觀數據狀態』，不是前瞻預測。如果使用者的問法明顯是要買賣建議或漲跌預測，講完客觀技術現況後要明講一句『這是目前的數據狀態，不是預測未來會漲會跌，也不是買賣建議，要不要進場請自行判斷』，不要含糊帶過。",
